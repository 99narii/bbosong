        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-4">
              <a href={siteData.social.kakao} className="text-gray-400 hover:text-teal-500 transition-colors" aria-label="카카오톡">
              ...
              <a href={siteData.social.naver} className="text-gray-400 hover:text-teal-500 transition-colors" aria-label="네이버 블로그">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M16.273 12.845L7.376 0H0v24h7.727V11.155L16.624 24H24V0h-7.727v12.845z"/>
                </svg>
              </a>
              <a href={siteData.social.instagram} className="text-gray-400 hover:text-teal-500 transition-colors" aria-label="인스타그램">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
